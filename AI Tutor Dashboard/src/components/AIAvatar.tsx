  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="bg-white/95 backdrop-blur-xl border-2 border-blue-400/40 rounded-2xl px-8 py-4 shadow-xl shadow-blue-200/50">
          <div className="flex items-center gap-4">
            ...
            {(isSpeaking || isListening) && (
              <div className="flex gap-1 ml-2">
                ...
                <div className="w-1 h-4 bg-blue-400 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }} />
              </div>
            )}
          </div>
        </div>
